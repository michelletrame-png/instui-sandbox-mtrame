...
export function desktopAgentOpen({ sharedTokens }: FrameCtx): React.ReactNode {
              ...
              <Flex direction="column" gap="medium">
                <Flex direction="column" gap="small">
                  ...
                  <Text size="descriptionPage">
                    Overview of your institution's courses, activity, and recent
                    updates.
                  </Text>
                </Flex>
                <Flex gap="small">
          ...
          >
            <Flex direction="column" height="100%">
              ...
              <View
                as="div"
                display="block"
                padding="none mediumSmall mediumSmall"
              >
                <View
                  as="div"
                  background="primary"
...
export const desktopAgentOpenCode = `<View
  as="div"
  width="100%"
  height="100%"
  background="secondary"
