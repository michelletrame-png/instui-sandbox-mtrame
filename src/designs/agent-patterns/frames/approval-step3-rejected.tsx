...
export function approvalStep3Rejected({ sharedTokens }: FrameCtx): React.ReactNode {
          ...
          <Flex.Item shouldGrow shouldShrink overflowY="auto">
            <View as="div" display="block" padding="large medium">
              <Flex direction="column" gap="large">
                ...
                {/* Agent response — compact rejection */}
                      ...
                      <Flex direction="column" gap="medium">
                        <Flex gap="small">
                          <Flex.Item shouldGrow shouldShrink size="0px">
                            <Button color="success" withBackground={false} display="block" interaction="disabled" renderIcon={<CheckInstUIIcon />}>Approve</Button>
                          </Flex.Item>
                          <Flex.Item shouldGrow shouldShrink size="0px">
                            <Button color="danger" withBackground={false} display="block" interaction="disabled" renderIcon={<XInstUIIcon />}>Reject</Button>
                          </Flex.Item>
                        </Flex>
                        <Alert variant="warning" renderCloseButtonLabel={false} hasShadow={false} margin="0">
                          You rejected the agent's planned actions. Tell the agent what it should do instead.
                        </Alert>
                      </Flex>
                    </View>
                  </View>
