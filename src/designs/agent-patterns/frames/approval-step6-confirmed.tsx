...
export function approvalStep6Confirmed({ sharedTokens }: FrameCtx): React.ReactNode {
              ...
              <Flex direction="column" gap="large">
                ...
                <Flex direction="column" gap="medium">
                  <Flex direction="column" gap="small">
                    ...
                    <Text size="content">Messages sent! Here's a <Link href="#">link to your message.</Link> What would you like to do next?</Text>
                  </Flex>
                  <Flex gap="xx-small">
                  ...
                  <Flex direction="column" gap="small">
                    <Button color="secondary" display="block" textAlign="start">Send a follow-up message</Button>
                    <Button color="secondary" display="block" textAlign="start">Draft another announcement</Button>
                    <Button color="secondary" display="block" textAlign="start">View the sent message</Button>
                  </Flex>
