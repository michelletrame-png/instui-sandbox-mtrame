...
export function agentApprovals({ sharedTokens }: FrameCtx): React.ReactNode {
              ...
              <Flex direction="column" gap="large">
                ...
                <Flex justifyItems="end" padding="0 0 0 large">
                  <View
                    ...
                    padding="mediumSmall"
                  >
                    <Text>Draft a message reminding students that late work can be submitted within seven days for partial credit, and that extensions may be approved in case of illness or emergencies.</Text>
                  </View>
                </Flex>
                ...
                <Flex direction="column" gap="medium">
                  <Flex direction="column" gap="small">
                    ...
                    <Text size="content">I've drafted a message for you. Review below and let me know if you have any changes.</Text>
                  </Flex>
                    ...
                    <View as="div" display="block" padding="0 mediumSmall mediumSmall mediumSmall">
                      <Flex direction="column" gap="small">
                        ...
                        <Flex direction="column" gap="xxx-small">
                          ...
                          <Text>Reminder that late work can be submitted within seven days for partial credit. Extensions may be approved in cases of illness or emergencies.</Text>
                        </Flex>
                      </Flex>
                    </View>
...
export const agentApprovalsCode = `<View as="div" width="100%" height="100%" background="secondary" themeOverride={{ backgroundSecondary: sharedTokens.background.pageColor }} padding="small" display="block">
  <View as="div" width="100%" height="100%" background="primary" themeOverride={{ backgroundPrimary: sharedTokens.background.containerColor }} borderRadius={sharedTokens.borderRadius.card.lg} shadow="resting" display="block" overflowY="hidden" overflowX="hidden">
    <Flex direction="column" height="100%">
      ...
      <View as="div" display="block" padding="small mediumSmall" background="primary" themeOverride={{ backgroundPrimary: \`linear-gradient(to right, \${sharedTokens.background.aiTopGradientColor} 0%, \${sharedTokens.background.aiBottomGradientColor} 100%)\` }}>
        <Flex alignItems="center" justifyItems="space-between">
          <Flex alignItems="center" gap="x-small">
            <IgniteaiLogoInstUIIcon color="onColor" size="md" />
            <Heading level="h2" variant="titleCardRegular" color="primary-on" margin="0">IgniteAI Agent</Heading>
        ...
        <View as="div" display="block" padding="large medium">
          <Flex direction="column" gap="large">
            ...
            <Flex direction="column" gap="medium">
              ...
              <View as="div" display="block" background="primary" themeOverride={{ backgroundPrimary: sharedTokens.background.containerColor, borderColorPrimary: sharedTokens.stroke.mutedColor }} borderWidth="small" borderColor="primary" borderRadius={sharedTokens.borderRadius.card.md} overflowX="hidden" overflowY="hidden">
                <View as="div" display="block" padding="mediumSmall mediumSmall small mediumSmall">
                  <Flex alignItems="center" justifyItems="space-between">
                    <Heading level="h3" variant="titleCardMini" margin="0">Send message</Heading>
                    <Flex gap="xx-small">
