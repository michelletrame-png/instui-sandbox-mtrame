...
export function agentErrorBasic({ sharedTokens }: FrameCtx): React.ReactNode {
              ...
              <Flex direction="column" gap="large">
                ...
                <Flex direction="column" gap="small">
                  <Flex gap="x-small" alignItems="center">
                    ...
                    <Text weight="bold" color="danger">Your request couldn't be completed</Text>
                  </Flex>
                  <Text size="content">It looks like you're asking for help with a long or complex task that can't be completed all at once. Try simplifying the request or breaking it into smaller steps.</Text>
                </Flex>
...
export const agentErrorBasicCode = `<Flex direction="column" gap="small">
  <Flex gap="x-small" alignItems="center">
    <CircleAlertInstUIIcon color="error" size="x-small" />
    <Text weight="bold" color="danger">Your request couldn't be completed</Text>
  </Flex>
