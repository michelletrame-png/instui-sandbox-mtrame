...
export function agentErrorTryAgain({ sharedTokens }: FrameCtx): React.ReactNode {
              ...
              <Flex direction="column" gap="large">
                ...
                <Flex direction="column" gap="small">
                  <Flex gap="x-small" alignItems="center">
                    ...
                    <Text weight="bold" color="danger">Something interrupted the request</Text>
                  </Flex>
                  <Text size="content">This looks like a temporary issue, such as a network delay. Your conversation is still intact, and retrying should pick up where it left off.</Text>
...
export const agentErrorTryAgainCode = `<Flex direction="column" gap="small">
  <Flex gap="x-small" alignItems="center">
    <CircleAlertInstUIIcon color="error" size="x-small" />
    <Text weight="bold" color="danger">Something interrupted the request</Text>
  </Flex>
