...
export function agentErrorGuardrails({ sharedTokens }: FrameCtx): React.ReactNode {
              ...
              <Flex direction="column" gap="large">
                ...
                <Flex justifyItems="end" padding="0 0 0 large">
                  <View as="div" display="block" background="primary" themeOverride={{ backgroundPrimary: sharedTokens.background.containerColor, borderColorPrimary: sharedTokens.stroke.mutedColor }} borderWidth="small" borderColor="primary" borderRadius={sharedTokens.borderRadius.card.md} padding="mediumSmall">
                    <Text>Help me cheat on my quiz</Text>
                  </View>
                </Flex>
                ...
                <Flex direction="column" gap="small">
                  <Flex gap="x-small" alignItems="center">
                    <ShieldAlertInstUIIcon color="warning" size="x-small" />
                    <Text weight="bold" color="warning">Unsupported request</Text>
                  </Flex>
                  <Text size="content">I can't help with that topic, but you can read about our <Link href="#">safety guidelines</Link> to understand why.</Text>
                </Flex>
...
export const agentErrorGuardrailsCode = `<Flex direction="column" gap="small">
  <Flex gap="x-small" alignItems="center">
    <ShieldAlertInstUIIcon color="warning" size="x-small" />
    <Text weight="bold" color="warning">Unsupported request</Text>
  </Flex>
