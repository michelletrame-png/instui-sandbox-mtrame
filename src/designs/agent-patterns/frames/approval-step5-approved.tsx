...
export function approvalStep5Approved({ sharedTokens }: FrameCtx): React.ReactNode {
                  ...
                  >
                    ...
                    <View as="div" display="block" padding="mediumSmall">
                      <Flex direction="column" gap="medium">
                        ...
                        <Alert variant="success" renderCloseButtonLabel={false} hasShadow={false} margin="0">
                          You approved the agent's planned actions.
                        </Alert>
                      </Flex>
                    </View>
                  </View>
